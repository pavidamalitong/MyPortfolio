  ...
  return (
    ...
    <Wrapper>
      <LeftContainer>
        ...
        <Description><br></br>
          I had a data visualization internship experience and strongly interest in web application.<br></br>
          I currently look for software development internship opportunity.
        </Description>
      </LeftContainer>
